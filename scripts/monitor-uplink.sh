...
# Check for restoring needed
# We skip the long wait loop here as this script is intended to be run
# periodically or after network-online.target.
# We do a quick check just in case.
